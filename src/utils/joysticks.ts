...
export class JoysticksController {
    ...
    createJoysticks() {
        ...
        mainCameraIgnoreList.push(
            spellJoystick1.base, spellJoystick1.thumb,
            spellJoystick2.base, spellJoystick2.thumb,
            spellJoystick3.base, spellJoystick3.thumb,
            spellJoystick4.base, spellJoystick4.thumb
        );

        // Все джойстики, которые должны блокировать друг друга
        this.spellJoysticksArr.push(
            viewAngleJoystick,
            spellJoystick1,
            spellJoystick2,
            spellJoystick3,
    ...
    private createBlockingJoystick(
      ...
      joystick.base.setInteractive(
          new Phaser.Geom.Circle(0, 0, baseRadius),
          Phaser.Geom.Circle.Contains
      );

      joystick.on('pointerdown', () => {
          console.log('Joystick pointerdown', joystick); // Добавьте лог для отладки
      ...
      joystick.on('pointerup', () => {
          console.log('Joystick pointerup', joystick); // Добавьте лог для отладки
